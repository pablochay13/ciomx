...
<div id="theme-main-banner" class="banner-one meraba">
	<div data-src="images/slideshow/slide-1.jpg">
		<div class="camera_caption">
			<div class="container">
				<p class="wow fadeInUp animated">CIO CONSULTORIA EMPRESARIAL</p>
				<h1 class="wow fadeInUp animated" data-wow-delay="0.2s">DESARROLLO INTEGRAL <br> PARA TU EMPRESA</h1>
				<a href="about.html" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">CONTACTO</a>
			</div> <!-- /.container -->
		</div> <!-- /.camera_caption -->
	</div>
	<div data-src="images/slideshow/slide-2.jpg">
		<div class="camera_caption">
			<div class="container">
				<p class="wow fadeInUp animated white">CIO CONSULTORIA EMPRESARIAL</p>
				<h1 class="wow fadeInUp animated white" data-wow-delay="0.2s">DESARROLLO INTEGRAL <br> PARA TU EMPRESA</h1>
				<a href="about.html" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">CONTACTO</a>
			</div>
		</div>
	</div>
	<div data-src="images/slideshow/slide-3.jpg">
		<div class="camera_caption">
			<div class="container">
				<p class="wow fadeInUp animated">CIO CONSULTORIA EMPRESARIAL</p>
				<h1 class="wow fadeInUp animated" data-wow-delay="0.2s">DESARROLLO INTEGRAL <br> PARA TU EMPRESA</h1>
